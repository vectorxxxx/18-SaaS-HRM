...
public class DatabaseUtil extends JFrame
{
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new DefaultComboBoxModel(new String[] {"--请选择数据库--"}));
                ...
                .addGroup(GroupLayout.Alignment.TRAILING, layout
                        ...
                        .addGroup(layout
                                ...
                                .addGroup(GroupLayout.Alignment.LEADING, layout
                                        ...
                                        .addGroup(layout
                                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addComponent(jComboBox2, GroupLayout.Alignment.TRAILING, 0, 174, Short.MAX_VALUE)
                                                .addComponent(jTextField1, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE)
                                                .addComponent(jComboBox1, GroupLayout.Alignment.TRAILING, 0, 174, Short.MAX_VALUE)
                                                .addComponent(jTextField3, GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE)
                                                .addComponent(jTextField2, GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE))))
                        .addGap(106, 106, 106)));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        if (this.jButton2
            ...
            JOptionPane.showMessageDialog(null, "请选择数据库", "提示", JOptionPane.OK_OPTION);
        }
    }
